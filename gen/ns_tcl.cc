...
\"\n\
checkout_executable TCLSH \"/home/kedia/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/kedia/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
Agent/MyPing set num_packets_ 5\n\
Agent/MyPing set interval_ 1.0\n\
...
newDSDV {\n\
set ragent [$self create-newdsdv-agent $node]\n\
}\n\
DSR {\n\
...
\n\
Simulator instproc create-newdsdv-agent { node } {\n\
set ragent [new Agent/newDSDV]\n\
set addr [$node node-addr]\n\
$ragent addr $addr\n\
$ragent node $node\n\
if [Simulator set mobile_ip_] {\n\
...
$node addr $addr\n\
$node set ragent_ $ragent\n\
$self at 0.0 \"$ragent start-newdsdv\"    ;# start updates\n\
return $ragent\n\
}\n\
\n\
